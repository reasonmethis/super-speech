...
class EmbedPublicIdsMigration:
    ...
    The journal deliberately omits the retired catalog's sequence high-water mark.
    After cutover, sequences are ordering metadata and may be reused once absent;
    only public IDs carry durable identity.
    """
...
def allocate_identity(
    ...
    *,
    ...
    public_id = generate_public_id(
        catalog.ids_by_sequence.values(), generate=generate
    )
